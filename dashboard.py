...
FIELD_TOOLTIPS = {
    ...
    "Cheap stage provider": "Model provider for the shortlist reranker. This stage should be fast and only sees the top local matches.",
    "Cheap stage model": "Specific fast model used for shortlist reranking after local fast-rank pruning.",
