...
class DeterministicFilterTests(unittest.TestCase):
    ...
    # Location and salary checks are handled by the cheap AI stage via
    # screening_constraints in MatchScorer._build_cheap_prompt(), which
    # allows more nuanced decisions than hard string filters here.
